...
public class Units {
	...
	public static enum DIGIT_FORMAT {
		...
		EXTENDED("    00:00:00:000", "extend"), FULL("000:00:00:00:000", "full") , NO_MS_SHORT("       00:00    ","no_ms");
	...
	public static enum UPDATE_TYPE {
		ADD_NEW, UPDATE_HEAD_LINE1, UPDATE_HEAD_LINE2, UPDATE_HEAD_LINE3, UPDATE_HEAD_DIGIT, DELETE,
